...
public class WhiteB_ground {
	WebDriver driver;

public  WhiteB_ground(WebDriver driver) {
	this.driver = driver;
}


@FindBy(how = How.XPATH, using = "//button[@onclick='myFunctionSky()']")WebElement SKY_BLUE_BUTTON;	
@FindBy(how=How.XPATH, using = "//button[@onclick='myFunctionWhite()']")WebElement WHITE_BACKGROUND_BUTTON;
...
public void whiteB_ground() throws Throwable {
	Thread.sleep(2000);
